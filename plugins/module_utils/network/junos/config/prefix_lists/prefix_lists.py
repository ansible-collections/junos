...
class Prefix_lists(ConfigBase):
    ...
    def execute_module(self):
        ...
        if state == "gathered":
            ...
            result["parsed"] = self.get_prefix_lists_facts(
                data=running_config
            )
    ...
    def set_state(self, want, have):
        ...
        self.prefix_lists = build_child_xml_node(self.root, "prefix-lists")
        state = self._module.params["state"]
        if (
